...
`,m=()=>i.jsxs(s,{children:[i.jsx("nav",{children:i.jsx(n,{})}),i.jsxs("div",{className:"container page",children:[i.jsxs("div",{className:"info",children:[i.jsxs("h1",{children:["job ",i.jsx("span",{children:"tracking"})," app"]}),i.jsx("p",{children:"I'm baby wayfarers hoodie next level taiyaki brooklyn cliche blue bottle single-origin coffee chia. Aesthetic post-ironic venmo, quinoa lo-fi tote bag adaptogen everyday carry meggings +1 brunch narwhal."}),i.jsx(a,{to:"/register",className:"btn register-link",children:"Register"}),i.jsx(a,{to:"/login",className:"btn",children:"Login / Demo User"})]}),i.jsx("img",{src:r,alt:"job hunt",className:"img main-img"})]})]});export{m as default};
